...
const SHORTRANGE = 1000    // the delay range until non-selected elements begin their animation
const LONGRANGE = 2000    // the delay range until the selected element begins its animation
