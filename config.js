const FADEDURATION = 1000 // this needs to match our css fade animation duration
const MINDELAY = 0 // the minimum delay until the animation begins
const SHORTRANGE = 5 // the delay range until non-selected elements begin their animation
const LONGRANGE = 10 // the delay range until the selected element begins its animation
